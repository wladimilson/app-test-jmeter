...
namespace app_test_jmeter.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var user = await _context.AdmUsers.SingleOrDefaultAsync(m => m.Id == id);
            if (user == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Age,Username,Password,PerfilImage")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
